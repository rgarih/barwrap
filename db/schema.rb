...
ActiveRecord::Schema.define(version: 2019_09_23_165255) do
  ...
  create_table "followings", force: :cascade do |t|
    ...
    t.index ["following_id", "follower_id"], name: "index_followings_on_following_id_and_follower_id", unique: true
